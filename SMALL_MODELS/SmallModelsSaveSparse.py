...
file_out = "/media/DANE/DANE/covid19/SRA_container/SmallModelsOutput_Sparse.npz"
SNP_ID_file_out = '/media/DANE/home/jliu/SRA/ANNOTATE_DATA/SNP_ID_post_SmallModels_shuffled.txt'
...
# here parallelization occurs
NumCPUs = mp.cpu_count()-50

if __name__ == '__main__':
    processes = []
    for _ in range(NumCPUs):
        p = mp.Process(target=target_function)
        p.start()
        processes.append(p)
